...
public class SecurityConfig {
    ...
    private final String[] URLList = {"/","/home","/login","/signup","/user",AppConstants.GET, AppConstants.CSS, AppConstants.JS, AppConstants.IMG, AppConstants.SCSS,AppConstants.VENDOR};
	@Autowired
